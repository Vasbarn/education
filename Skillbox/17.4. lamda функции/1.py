...
print(lambda elem: elem in grades)
print("Минимальное значение: ", min(grades, key=lambda elem: elem.get("score")))
print("Максимальное значение значение: ", max(grades, key=lambda elem: elem.get("score")))